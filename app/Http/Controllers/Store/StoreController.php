...
class StoreController extends BaseController{
    ...
    public function index(){
        ...
        return \View::make('store.pages.index', array(
            ...
            // 'jewels' => $jewels,
            'articles' => $articles,
            'latest_by_materials' => $this->latestByMaterials(),
    ...
    private function latestByMaterials(){
        $materials = Material::with("productsOnline")->groupBy('parent_id')->get();
        return view('latest_by_material', compact('materials'));
    }
}