...
<div class="modal fade" id="addRepair" role="dialog" aria-labelledby="addRepair" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<form method="POST" action="repairs" name="repairs" data-type="add" autocomplete="off">
				...
				<div class="modal-footer">
					...
					<button type="button" id="certificate" class="certificate btn btn-primary">Разписка</button>
...
<div class="modal fade edit--modal_holder" id="fullEditRepair" role="dialog" aria-labelledby="fullEditRepair" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
...
<div class="modal fade" id="returnRepair" role="dialog" aria-labelledby="returnRepair" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
...
<div class="modal fade" id="scanRepair" role="dialog" aria-labelledby="scanRepair" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
		...
		<div class="bgc-white bd bdrs-3 p-20 mB-20">
			<h4 class="c-grey-900 mB-20">Ремонти
				...
				@if(in_array(Auth::user()->role, array('storehouse', 'admin')))
					...
					<button type="button" class="scan-repair btn btn-primary" data-form-type="add" data-form="scanRepair" data-toggle="modal" data-target="#scanRepair">Обработи</button>
				@endif
			</h4>
			...
			<table id="main_table" class="table repair-records-table tablesort table-fixed">
				...
				@foreach($repairs as $repair)
					@if(
						...
						$loggedUser->role !== 'storehouse' &&
						$repair->store_id == $loggedUser->store_id
					)
						@include('admin.repairs.table')
					@elseif(in_array($loggedUser->role, array('admin','storehouse')))
						@include('admin.repairs.table')
					@endif
				@endforeach
				</tbody>
