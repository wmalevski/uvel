                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="material" class="form-control">
                        ...
                        @foreach($materials as $material)
                            <option value="{{ $material->id }}" @if($repair->material == $material->id) selected @endif>{{ App\Materials_type::withTrashed()->find($material->parent)->name }} - {{ $material->color }} - {{ $material->code }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
