<tr data-id="{{$repair->id}}">
    ...
    <td> @if($repair->status == 'done') <span class="return-repair-action" data-url="repairs/return/{{$repair->code}}" data-repair-return><i class="c-brown-500 ti-reload"></i></span> @endif
