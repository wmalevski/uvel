<tr>
    ...
    <td> @if($repair->status == 'repairing') 
        <span data-url="repairs/{{$repair->id}}" class="edit-btn" data-toggle="modal" data-target="#fullEditRepair"><i class="c-brown-500 ti-pencil"></i></span> @endif @if($repair->status == 'done') <span href="repairs/return/{{$repair->id}}" class="edit-btn" data-toggle="modal" data-target="#returnRepair"><i class="c-brown-500 ti-reload"></i></span> @endif
