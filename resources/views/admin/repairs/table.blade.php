<tr>
    ...
    <td> @if($repair->status == 'repairing') <a href="repairs/{{$repair->id}}" class="edit-btn" data-toggle="modal" data-target="#fullEditRepair"><i class="c-brown-500 ti-pencil"></i></a> @endif @if($repair->status == 'done') <a href="repairs/return/{{$repair->id}}" class="edit-btn" data-toggle="modal" data-target="#returnRepair"><i class="c-brown-500 ti-reload"></i></a> @endif 
