<tr data-id="{{ $model->id }}">
    ...
    <td> {{ App\Price::withTrashed()->find($model->retail_price)->price }} </td> 
    <td> {{ App\Price::withTrashed()->find($model->wholesale_price)->price }} </td> 
    <td> {{ $model->weight }} </td>
    <td> {{ (App\Price::withTrashed()->find($model->retail_price)->price)*$model->weight }} </td>
    <td>
