    ...
    <tr data-id="{{ $product->id }}">
        <td class="thumbnail--tooltip">
            @if($product->photos())
                ...
                @if($prodPhoto)
                    background-image: url({{ getPhoto("products/".$prodPhoto) }});
                @endif
                "></ul>
            @elseif($product->model)
                ...
                @endphp
                @if($modPhoto)
                <img class="admin-product-image" src="{{ getPhoto("models/".$modPhoto) }}">
                @endif
                <ul class="product-hover-image" style="
                @if($modPhoto)
                background-image: url({{ getPhoto("models/".$modPhoto) }});
                @endif
                "></ul>
            @endif
        </td>
