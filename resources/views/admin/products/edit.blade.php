    ...
    <form method="POST" name="edit" action="/products/{{ $product->id }}">
        ...
        <div class="modal-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label>Вид: </label>
                    <select id="jewel_edit" name="jewel_id" class="form-control jewels_types" disabled>
                        <option value="">Избери</option>
            ...
            <div class="form-row model_materials">
                ...
                <div class="form-group col-md-6">            
                    ...
                    <select id="wholesale_price_edit" name="wholesale_price_id" class="form-control prices-filled wholesale-price wholesale_prices">
                        <option value="">Избери</option>
                        ...
                        <select name="stones[]" class="form-control">
                            ...
                            @foreach($stones as $stone)
                                <option value="{{ $stone->id }}" @if($modelStone->stone == $stone->id) selected @endif>
                                    ...
                                    ({{ $stone->stone->contour->name }}, {{ $stone->stone->size->name }})
                                </option>
                            @endforeach
                        </select>
                    </div>
