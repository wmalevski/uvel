            ...
            <form method="POST" name="products" action="/products" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label>Вид: </label>
                            <select id="jewels_types" name="jewel_id" class="form-control calculate" disabled>
                                <option value="">Избери</option>
                    ...
                    <div class="form-row model_materials">
                        <div class="form-group col-md-12">
                            ...
                            <select id="material" name="material_id" class="material_type form-control calculate">
                                ...
                                @foreach($materials as $material)
                                    @if(count($material->material->pricesBuy) > 0)
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="wholesale_prices" name="wholesale_price_id" class="form-control prices-filled wholesale-price">
                                <option value="0">Избери</option>
