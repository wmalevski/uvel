<tr data-id="{{ $jewel->id }}">
    <td>{{ $jewel->name }}</td> 
    <td>{{ App\Materials_type::withTrashed()->find($jewel->material)->name }} - {{ App\Materials::withTrashed()->find($jewel->material)->color }} - {{ App\Materials::withTrashed()->find(App\Materials::withTrashed()->find($jewel->material)->parent)->code }}</td> 
