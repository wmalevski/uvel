<tr data-id="{{ $slide->id }}">
    ...
    <td>
        <span data-url="slides/{{$slide->id}}" class="edit-btn" data-form-type="edit" data-form="sliders" data-toggle="modal" data-target="#editSlide">
            <i class="c-brown-500 ti-pencil"></i>
        </span>
        <span data-url="slides/delete/{{$slide->id}}" class="delete-btn">
