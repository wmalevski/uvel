<tr data-id="{{ $order->id }}">
    ...
    <td><span data-url="orders/model/{{$order->id}}" class="edit-btn" data-toggle="modal" data-target="#editOrder" data-form-type="edit" data-form="orders"><i class="c-brown-500 ti-pencil"></i></span>
