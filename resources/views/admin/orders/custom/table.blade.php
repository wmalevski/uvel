<tr data-id="{{ $order->id }}">
    ...
    <td>@if($order->status == 'pending') 
        ...
        @else 
            <span class="badge bgc-green-50 c-green-700 p-10 lh-0 tt-c badge-pill">Готов за получаване</span>  @endif</td> 
    <td><span data-url="orders/custom/{{$order->id}}" class="edit-btn" data-toggle="modal" data-target="#editOrder" data-form-type="edit" data-form="orders"><i class="c-brown-500 ti-pencil"></i></span>
