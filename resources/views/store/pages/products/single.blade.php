													...
													<div class="hover-appear">
														<form action="#" method="post">
															<div class="effect-ajax-cart">
																...
																<button class="select-option" type="button" onclick="window.location.href='{{ route('single_product', ['product' => $product->id]) }}'"><i class="fa fa-th-list" title="Преглед"></i><span class="list-mode">Select Option</span></button>
															</div>
														</form>
...
>>>>>>> 0e5c08f9458f6902f3befabb76b5781c4c1d59f6
														...
														<a class="wish-list" href="#" data-url="{{ route('wishlists_store', ['type' => 'product', 'item' => $product->id]) }}" title="Наблюдавани"><i class="fa fa-heart"></i><span class="list-mode">Добави в желани</span></a>
													</div>
													</li>
												</ul>
                                            </div>
