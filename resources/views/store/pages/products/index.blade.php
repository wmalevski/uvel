											...
											<div class="tag-group" id="coll-filter-3">
												...
												<ul>
													@foreach($materials as $material)
														<li>
															<a title="Narrow selection to products matching tag Under $100" href="#" data-id="byMaterial[]={{ $material->id }}"><span
																	class="fe-checkbox"></span> {{ $material->parent->name }} ({{ $material->color }}) ({{
																count($material->productsOnline) }})</a>
														</li>
													@endforeach
												</ul>
											</div>
											...
											<div class="tag-group" id="coll-filter-3">
												...
												<ul>
													@foreach($stores as $store)
														<li>
															<a title="Narrow selection to products matching tag Under $100" data-id="byStore[]={{ $store->id }}" href="#">
															<span class="fe-checkbox"></span>
