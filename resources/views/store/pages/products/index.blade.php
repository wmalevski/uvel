                                ...
                                <div id="product" class="content clearfix">      
                                    ...
                                    <div id="product-image" class="product-image row ">     
                                        <div id="detail-left-column" class="hidden-xs left-coloum col-sm-6 col-sm-6 fadeInRight not-animated" data-animate="fadeInRight">
                                            <div id="gallery_main" class="product-image-thumb thumbs full_width ">
                                                <ul class="slide-product-image">													
                                                    <li class="image">
                                                        <a href="./store/images/demo_100x100.png" class="cloud-zoom-gallery active">
                                                            <img src="{{ asset('store/images/demo_100x100.png') }}" alt="Donec condime fermentum">
                                                        </a>
                                                    </li>
                                                    <li class="image">
                                                    ...
                                                    <li class="image">
                                                        <a href="./assets/images/7_1024x1024.jpg" class="cloud-zoom-gallery">
                                                            <img src="{{ asset('store/images/demo_100x100.png') }}" alt="Donec condime fermentum">
                                                        </a>
                                                    </li>
                                                    <li class="image">
                                        ...
                                        <div class="image featured col-smd-12 col-sm-12 fadeInUp not-animated" data-animate="fadeInUp"> 
                                            <img src="{{ asset('store/images/demo_570x570.png') }}" alt="Donec condime fermentum">
                                        </div>
                                        ...
                                        <div id="product-header" class="clearfix">
                                            ...
                                            <div id="product-info-right">     
                                                        ...
                                                        <div id="product-actions-1293235843" class="options clearfix">
                                                            ...
                                                            <div class="swatch color clearfix" data-option-index="0">
                                                                ...
                                                                <div data-value="black" class="swatch-element color black available">
                                                                    ...
                                                                    <img class="crossed-out" src="{{ asset('store/images/soldout.png') }}" alt="">
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <div class="swatch clearfix" data-option-index="1">
                                                                ...
                                                                <div data-value="small" class="swatch-element small available">
                                                                    ...
                                                                    small <img class="crossed-out" src="{{ asset('store/images/soldout.png') }}" alt="">
                                                                    </label>
                                                                </div>
                                                                <div data-value="medium" class="swatch-element medium available">
                                                                    <input id="swatch-1-medium" name="option-1" value="medium" type="radio">
                                                                    <label for="swatch-1-medium">
                                                                    medium <img class="crossed-out" src="{{ asset('store/images/soldout.png') }}" alt="">
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="pop-one" style="display: none;">
                                                    <img src="{{ asset('store/images/demo_870x580.png') }}" alt="">
                                                </div>
                                    ...
                                    <div class="prod-related clearfix">
                                        <div class="element no_full_width not-animated" data-animate="bounceIn" data-delay="0">
                                            <ul class="row-container list-unstyled clearfix">
                                                ...
                                                <img src="{{ asset('store/images/demo_270x270.png') }}" class="img-responsive" alt="Curabitur cursus dignis">
                                        ...
                                        <div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="400">
                                            <ul class="row-container list-unstyled clearfix">
                                                <li class="row-left">
                                                <a href="./product.html" class="container_item">
                                                <img src="{{ asset('store/images/demo_270x270.png') }}" class="img-responsive" alt="Donec aliquam ante non">
                                                <span class="sale_banner">
                                                <span class="sale_text">Sale</span>
                                                </span>
                                                </a>
                                        ...
                                        <div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="600">
                                            <ul class="row-container list-unstyled clearfix">
                                                <li class="row-left">
                                                <a href="./product.html" class="container_item">
                                                <img src="{{ asset('store/images/demo_270x270.png') }}" class="img-responsive" alt="Donec condime fermentum">
                                                </a>
                                                <div class="hbw">
                                                    <span class="hoverBorderWrapper"></span>
                                                </div>
                                        ...
                                        <div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="800">
                                            <ul class="row-container list-unstyled clearfix">
                                                <li class="row-left">
                                                <a href="./product.html" class="container_item">
                                                <img src="{{ asset('store/images/demo_270x270.png') }}" class="img-responsive" alt="Maximus quam posuere">
                                                <span class="sale_banner">
                                                <span class="sale_text">Sale</span>
                                                </span>
                                                </a>
                                        ...
                                        <div class="element no_full_width not-animated" data-animate="bounceIn" data-delay="1000">
                                            <ul class="row-container list-unstyled clearfix">
                                                <li class="row-left">
                                                <a href="./product.html" class="container_item">
                                                <img src="{{ asset('store/images/demo_270x270.png') }}" class="img-responsive" alt="Product full width">
                                                <span class="sale_banner">
                                                <span class="sale_text">Sale</span>
                                                </span>
                                                </a>
