											...
											<div class="filter-tag-group" data-url="ajax/filter/products">
												...
												<div class="tag-group" id="coll-filter-3">
													...
													<ul>
														...
														<li><a title="Narrow selection to products matching tag Under $100" data-id="byStore[]={{ $store->id }}"
															 href="#"><span class="fe-checkbox"></span> {{ $store->name }} ({{ count($store->productsOnline) }})</a></li>
														@endforeach
													</ul>
												</div>
												<!-- tags groupd 3 -->
												...
												<div class="tag-group" id="coll-filter-3">
													...
													<ul>
														...
														<li><a title="Narrow selection to products matching tag Under $100" href="#" data-id="byJewel[]={{ $jewel->id }}"><span
																 class="fe-checkbox"></span> {{ $jewel->name }} ({{ count($jewel->productsOnline) }})</a></li>
														@endforeach
													</ul>
												</div>
												<!-- tags groupd 3 -->
												...
												<div class="tag-group" id="coll-filter-3">
													...
													<ul>
														...
														<li><a title="Narrow selection to products matching tag Under $100" href="#" data-id="byMaterial[]={{ $material->id }}"><span
																 class="fe-checkbox"></span> {{ $material->parent->name }} ({{ $material->color }}) ({{
																count($material->productsOnline) }})</a></li>
