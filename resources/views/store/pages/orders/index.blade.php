                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="left-block col-md-12">
                                        <form method="post" action="{{ route('submit_custom_order') }}" data-form-captcha
                                            class="contact-form customOrder-form" accept-charset="UTF-8"
                                            enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <input type="hidden" value="contact" name="form_type">
                                            <input type="hidden" name="utf8" value="✓">
                                            <div id="custom_order" data-size="invisible" data-captcha="custom_order"
                                            ...
                                            <ul id="contact-form" class="row list-unstyled">
                                                ...
                                                <li class="">
                                                    ...
                                                    <input type="text" id="city" value="{{ $usercity }}"
                                                        class="form-control email" name="city">
                                                </li>
                                                ...
                                                <li class="">
                                                    ...
                                                    <input type="tel" id="phone" value="{{ $userphone }}"
                                                        class="form-control email" name="phone">
                                                </li>
                                                <li class="clearfix"></li>
                                                <li class="">
                                                    ...
                                                    <textarea id="message" rows="5" class="description form-control" name="content"></textarea>
                                                </li>
                                                <li>
                                                    <label class="control-label">Снимки</label>
                                                    <div class="drop-area" name="add">
                                                        <input type="file" name="images[]" class="drop-area-input"
                                                            id="fileElem-add" accept="image/*" multiple>
                                                ...
                                                <li class="unpadding-top">
                                                    ...
                                                    <input type="hidden" name="archive_date"
                                                        value="{{ $archive_date }}" />
                                                    <input type="hidden" name="size" value="{{ $size }}" />
                                                    <input type="hidden" name="weight" value="{{ $weight }}" />
                                                    <input type="hidden" name="type" value="{{ $type }}" />
                                                    <input type="hidden" name="unique_number"
                                                        value="{{ $unique_number }}" />
                                                </li>
                                                <li>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const oldDescription = "{{ $content }}";
        if (oldDescription) {
            $(".description").val(oldDescription).change();
        }
    });
</script>
@endpush
