		...
		<div class="row">
			<div class="col-md-12 product-image">
				<div id="quick-shop-image" class="product-image-wrapper">
					<a class="main-image">
						<img class="img-zoom img-responsive image-fly" src="@if($model->photos){{ asset("uploads/models/" . $model->photos->first()['photo']) }}@endif"/>
					</a>
					...
					<div id="gallery_main_qs" class="product-image-thumb">
						...
						<a class="image-thumb active" href="{{ asset("uploads/models/" . $image->photo) }}" data-image="{{ asset("uploads/models/" . $image->photo) }}"
						 data-zoom-image="{{ asset("uploads/models/" . $image->photo) }}"><img src="{{ asset("uploads/models/" . $image->photo) }}"
							 alt="" /></a>
						@endforeach
						@endif
					</div>
