	...
	<ul class="row-container list-unstyled clearfix">
		...
		<li class="row-right parent-fly animMix @if($listType == 'goList') col-md-16 @endif">
			...
			<div class="hover-appear">
				<form action="#" method="post">
					<div class="effect-ajax-cart">
						...
						<button class="select-option" type="button" onclick="window.location.href='{{ route('single_product', ['product' => $product->id])  }}'"><i
							 class="fa fa-th-list" title="Преглед"></i><span class="list-mode">Преглед</span></button>
					</div>
				</form>
				...
				<a class="wish-list" data-url="{{ route('wishlists_store', ['type' => 'product', 'item' => $product->id]) }}" href="#"
